                ...
                <div class="card-body">
                    ...
                    <form id="form-add-penggajian">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control file-upload-info" id="nik_karyawan" name="nik_karyawan" readonly placeholder="Pilih File Absensi">
                            <span class="input-group-append">
                                <button class="file-upload-browse btn btn-primary" id="btn-upload-absensi" type="button"> Upload Absensi </button>
                            </span>
                            </div>
                        </div>
...
<script src="<?= base_url('public/admin/absensi/absensi_2.js') ?>" ></script>
